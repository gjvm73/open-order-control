        ...
        {activeTab === "delivered" ? (
          ...
          <section data-print-management className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
              ...
              <MetricCard label="Tempo médio em aberto" value={managementOverview.delivery.averageOpenDays === null ? "—" : `${Math.ceil(managementOverview.delivery.averageOpenDays)} dias`} detail={`${managementOverview.delivery.lifecycleMeasuredItems} entrega(s) com ciclo mensurável`} icon={<Clock3 className="w-4 h-4" />} accent="red" />
